...
function setDateFromNotified() {
	var dateNotified = new Date(document.getElementById('dateNotified').value);
	document.getElementById('dateConfirmed').value = "";
	dateConfirmed.min = dateNotified.toISOString().split("T")[0];
}
function setDateFromOnset() {
	var dateOnset = new Date(document.getElementById('dateOnset').value);
	document.getElementById('dateHospitalisation').value = "";
	dateHospitalisation.min = dateOnset.toISOString().split("T")[0];
	document.getElementById('dateDischarge').value = "";
	dateDischarge.min = dateOnset.toISOString().split("T")[0];
	document.getElementById('dateSeenHousehold1').value = "";
	dateSeenHousehold1.min = dateOnset.toISOString().split("T")[0];
	document.getElementById('dateSeenHousehold2').value = "";
	dateSeenHousehold2.min = dateOnset.toISOString().split("T")[0];
	document.getElementById('dateSeenOther1').value = "";
	dateSeenOther1.min = dateOnset.toISOString().split("T")[0];
	document.getElementById('dateSeenOther2').value = "";
	dateSeenOther2.min = dateOnset.toISOString().split("T")[0];
}
function setDateFromHospitalisation() {
	var dateHospitalisation = new Date(document.getElementById('dateHospitalisation').value);
	document.getElementById('dateDischarge').value = "";
	dateDischarge.min = dateHospitalisation.toISOString().split("T")[0];
}
function setDateFromDischarge() {
	var dateDischarge = new Date(document.getElementById('dateDischarge').value);
	document.getElementById('dateSeenHousehold1').value = "";
	dateSeenHousehold1.max = dateDischarge.toISOString().split("T")[0];
	document.getElementById('dateSeenHousehold2').value = "";
	dateSeenHousehold2.max = dateDischarge.toISOString().split("T")[0];
	document.getElementById('dateSeenOther1').value = "";
	dateSeenOther1.max = dateDischarge.toISOString().split("T")[0];
	document.getElementById('dateSeenOther2').value = "";
	dateSeenOther2.max = dateDischarge.toISOString().split("T")[0];
}
function checkDOB(){	
...
function configurePHI(id1,id2) {
	...
	document.getElementById('pHIRange').options[0].disabled = true;
	document.getElementById('pHIRange').options[0].disabled = true;
}
