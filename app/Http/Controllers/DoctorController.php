...
class DoctorController extends Controller
{
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'hospital11' => 'nullable|string|max:50',
            'hospital12' => 'nullable|string|max:50',
            'hospital2' => 'nullable|string|max:50',
            'hospital3' => 'nullable|string|max:50',
            'hospital4' => 'nullable|string|max:50',
            'hospital5' => 'nullable|string|max:50',
            'otherHospital' => 'nullable|string|max:50',
        ]);
    }
