...
<div class="container" style="margin-top: 3%">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register-Laboratory Technician') }}</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <br>
                    <form method="POST" action="/labTechnician">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control{{ $errors->has('insName') ? ' is-invalid' : '' }}" id="insName" name="insName" value="Medical and Molecular Entomology Research Laboratory" readonly autofocus>
