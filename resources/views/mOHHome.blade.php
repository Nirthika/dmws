...
<div class="container" style="margin-top: 2%;">
    ...
    <div class="row justify-content-center" style="margin: auto;">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="padding-top: 2%; padding-bottom: 1%"><h5 style="font-weight: bold">Draft H399 Forms</h5></div>
                <div class="card-body" style="padding-top: 2%; padding-bottom: 1%">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="padding-top: 2%; padding-bottom: 1%"><h5 style="font-weight: bold">Sent H399 Forms</h5></div>
                <div class="card-body" style="padding-top: 2%; padding-bottom: 1%">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
    ...
    <div class="row justify-content-center" style="margin: auto;">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="padding-top: 2%; padding-bottom: 1%"><h5 style="font-weight: bold">Draft H411a Forms</h5></div>
                <div class="card-body" style="padding-top: 2%; padding-bottom: 1%">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="padding-top: 2%; padding-bottom: 1%"><h5 style="font-weight: bold">Sent H411a Forms</h5></div>
                <div class="card-body" style="padding-top: 2%; padding-bottom: 1%">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
    ...
    <div class="row justify-content-center" style="margin: auto;">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="padding-top: 2%; padding-bottom: 1%"><h5 style="font-weight: bold">Received H544 Forms</h5></div>
                <div class="card-body" style="padding-top: 2%; padding-bottom: 1%">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header" style="padding-top: 2%; padding-bottom: 1%"><h5 style="font-weight: bold">Received H411 Forms</h5></div>
                <div class="card-body" style="padding-top: 2%; padding-bottom: 1%">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <thead>
