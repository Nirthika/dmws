...
<div class="container">
	...
	<nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a class="nav-item nav-link" id="nav-heatMap-tab" data-toggle="tab" href="#nav-heatMap" role="tab" aria-controls="nav-heatMap" aria-selected="false">Heat Map</a>
            <a class="nav-item nav-link" id="nav-field-tab" data-toggle="tab" href="#nav-field" role="tab" aria-controls="nav-field" aria-selected="false">Field Survey</a>
        </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
		...
		<div class="tab-pane fade" id="nav-field" role="tabpanel" aria-labelledby="nav-field-tab">
        	<br/>
            <div class="card-deck">
		        <div class="card" style="width: 18rem;">
		            <div class="card-header">Field Survey Results Summary</div>
		            <div class="card-body">
